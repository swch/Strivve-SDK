...
export var generateHydrationHeader = function (hydrationArray) {
...
export var generateTraceValue = function (bytes) {
...
export var formatPath = function (path, filter) {
...
export var generateRandomPar = function (pan, exp_month, exp_year, salt) {
...
export var getCardBrand = function (pan) {
    var validationErrors = [];
    pan = pan.toString();
    var brandRegexes = {
        "visa": /^4[0-9]{12}(?:[0-9]{3})?$/,
