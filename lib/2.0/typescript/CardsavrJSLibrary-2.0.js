...
var JSLibraryError_1 = require("./JSLibraryError");
var CardsavrSessionResponse_1 = require("./CardsavrSessionResponse");
var CardsavrSessionUtilities = require("./CardsavrSessionUtilities");
var CardsavrCrypto = require("./CardsavrSessionCrypto");
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 7:
                            _a.data = _c.sent();
                            return [2 /*return*/, new CardsavrSessionResponse_1["default"](response.status, response.statusText, response.headers, response.data)];
                        case 8:
                            err_1 = _c.sent();
                            console.log(err_1);
                        ...
                        case 9:
                            _b.data = _c.sent();
                            throw new CardsavrSessionResponse_1["default"](err_1.response.status, err_1.response.statusText, err_1.response.headers, err_1.response.data);
