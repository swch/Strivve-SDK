...
import { CardsavrHelper } from '@strivve/strivve-sdk/lib/cardsavr/CardsavrHelper'
...
export default function Home() {
  ...
  async function post_job(event) {
    ...
    console.log("HERE1");
    var helper = CardsavrHelper.getInstance();
    console.log("HERE2");
    ...
    helper.placeCardOnSiteAndPoll(result.username, creds, 'staging', (message) => {
      if (message.type == 'job_status') { //status updates
        console.log(message.message);
      } else if (message.job_id && message.type.endsWith("_request")) {
        console.log(message);
      }
    });
  }
